...
## Project Structure
    ...
    ├── testapiautodatamod_102356  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_102356`
...
2. Clone this repo and `cd testapiautodatamod_102356`
